...
void zmdnet_print_addr(struct sockaddr *sa)
{
    ...
    case AF_INET6:
    {
        ...
        zmdnet_printf("IPv6 address: %x:%x:%x:%x:%x:%x:%x:%x:port:%d scope:%u\n",
            ntohs(sin6->sin6_addr.u.Word[0]),
            ntohs(sin6->sin6_addr.u.Word[1]),
            ntohs(sin6->sin6_addr.u.Word[2]),
            ntohs(sin6->sin6_addr.u.Word[3]),
            ntohs(sin6->sin6_addr.u.Word[4]),
            ntohs(sin6->sin6_addr.u.Word[5]),
            ntohs(sin6->sin6_addr.u.Word[6]),
            ntohs(sin6->sin6_addr.u.Word[7]),
